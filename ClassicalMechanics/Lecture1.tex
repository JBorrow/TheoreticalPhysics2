...
\begin{figure}[!htb]
	\centering
	\includegraphics[width=0.3\textwidth]{PointMassOnInclinedPlane.png}
\end{figure}
...
\begin{figure}[!htb]
    \centering
	\includegraphics[width=0.3\textwidth]{BeadOnRotatingWire.png}
\end{figure}
...
\begin{figure}[!htb]
	\centering
	\includegraphics[width=0.3\textwidth]{CoinOnPlane.png}
\end{figure}
